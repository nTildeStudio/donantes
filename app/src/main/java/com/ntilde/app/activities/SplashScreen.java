...
import com.ntilde.app.listeners.AnimationStateListener;
...
import com.ntilde.utils.DefaultConfig;
...
public class SplashScreen extends ActionBarActivity implements ParseResponse, SplashView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fillableLoader.setOnStateChangeListener(new AnimationStateListener(this, loaderRed, STATE_STARTED));
        loaderRed.setOnStateChangeListener(new AnimationStateListener(this, loaderGris, STATE_FINISHED));
        loaderGris.setOnStateChangeListener(new AnimationStateListener(this, null, STATE_FINISHED));
