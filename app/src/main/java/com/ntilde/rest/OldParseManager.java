...
public class OldParseManager {
    ...
    private static final String TAG = OldParseManager.class.getName();
        ...
        query.findInBackground(new FindCallback<UltimaActualizacion>() {
            ...
            public void done(List<UltimaActualizacion> list, ParseException e) {
                if(mCallback != null && e == null){
                    ...
                    mCallback.onError(DonantesApplication.getInstance().getString(R.string.error_retrieving_last_updated_date));
